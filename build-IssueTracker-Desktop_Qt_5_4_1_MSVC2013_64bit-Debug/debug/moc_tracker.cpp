...
#include "../../IssueTracker/tracker.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Tracker_t, stringdata) + ofs \
...
void Tracker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Tracker::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Tracker::modified)) {
                *result = 0;
            }
        }
    }
...
void *Tracker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Tracker.stringdata))
